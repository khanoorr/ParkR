...
const Signup = () => {
  ...
  const [userType, setUserType] = useState("parker");
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-large border-0 bg-gradient-card">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold">Join ParkR</CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-6">
            <Tabs value={userType} onValueChange={setUserType} className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6">
                <TabsTrigger value="parker">I need parking</TabsTrigger>
                <TabsTrigger value="host">I have space</TabsTrigger>
              </TabsList>
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <TabsContent value="parker" className="mt-0">
                  <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 text-sm">
                    <h4 className="font-medium mb-2">As a Parker, you'll be able to:</h4>
                ...
                <TabsContent value="host" className="mt-0">
                  <div className="bg-accent/5 border border-accent/20 rounded-lg p-4 text-sm">
                    <h4 className="font-medium mb-2">As a Host, you'll be able to:</h4>
                    <ul className="space-y-1 text-muted-foreground">
                      <li>• List multiple parking spaces</li>
                      <li>• Earn up to $200+ monthly</li>
